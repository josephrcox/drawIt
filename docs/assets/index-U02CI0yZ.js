 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yd="FirebaseError";class hn extends Error{constructor(e,t,r){super(t),this.code=e,this.customData=r,this.name=Yd,Object.setPrototypeOf(this,hn.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Qs.prototype.create)}}class Qs{constructor(e,t,r){this.service=e,this.serviceName=t,this.errors=r}create(e,...t){const r=t[0]||{},s=`${this.service}/${e}`,i=this.errors[e],a=i?Jd(i,r):"Error",l=`${this.serviceName}: ${a} (${s}).`;return new hn(s,l,r)}}function Jd(n,e){return n.replace(Zd,(t,r)=>{const s=e[r];return s!=null?String(s):`<${r}?>`})}const Zd=/\{\$([^}]+)}/g;function Ds(n,e){if(n===e)return!0;const t=Object.keys(n),r=Object.keys(e);for(const s of t){if(!r.includes(s))return!1;const i=n[s],a=e[s];if(dl(i)&&dl(a)){if(!Ds(i,a))return!1}else if(i!==a)return!1}for(const s of r)if(!t.includes(s))return!1;return!0}function dl(n){return n!==null&&typeof n=="object"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const to="[DEFAULT]",Ym={[eo]:"fire-core",[bm]:"fire-core-compat",[Rm]:"fire-analytics",[Im]:"fire-analytics-compat",[km]:"fire-app-check",[Cm]:"fire-app-check-compat",[Sm]:"fire-auth",[Pm]:"fire-auth-compat",[Vm]:"fire-rtdb",[Dm]:"fire-data-connect",[Nm]:"fire-rtdb-compat",[Mm]:"fire-fn",[Om]:"fire-fn-compat",[xm]:"fire-iid",[Lm]:"fire-iid-compat",[Fm]:"fire-fcm",[Um]:"fire-fcm-compat",[Bm]:"fire-perf",[jm]:"fire-perf-compat",[qm]:"fire-rc",[zm]:"fire-rc-compat",[Hm]:"fire-gcs",[Wm]:"fire-gcs-compat",[Gm]:"fire-fst",[$m]:"fire-fst-compat",[Km]:"fire-vertex","fire-js":"fire-js",[Qm]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yu=new Map;function Ju(n,e){const t=Xs(n);Zu(t,e),Sp(t,e)}function Zu(n,e){const t=Yu.get(n);if(t)for(const r of t)r(e)}function Sp(n,e){const t=Pp();t&&t.postMessage({key:n,fid:e}),Vp()}let Tn=null;function Pp(){return!Tn&&"BroadcastChannel"in self&&(Tn=new BroadcastChannel("[Firebase] FID Change"),Tn.onmessage=n=>{Zu(n.data.key,n.data.fid)}),Tn}function Vp(){Yu.size===0&&Tn&&(Tn.close(),Tn=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Dp="firebase-installations-database",Np=1,Rn="firebase-installations-store";let ji=null;function ko(){return ji||(ji=xu(Dp,Np,{upgrade:(n,e)=>{switch(e){case 0:n.createObjectStore(Rn)}}})),ji}async function Ms(n,e){const t=Xs(n),s=(await ko()).transaction(Rn,"readwrite"),i=s.objectStore(Rn),a=await i.get(t);return await i.put(e,t),await s.done,(!a||a.fid!==e.fid)&&Ju(n,e.fid),e}async function eh(n){const e=Xs(n),r=(await ko()).transaction(Rn,"readwrite");await r.objectStore(Rn).delete(e),await r.done}async function Ys(n,e){const t=Xs(n),s=(await ko()).transaction(Rn,"readwrite"),i=s.objectStore(Rn),a=await i.get(t),l=e(a);return l===void 0?await i.delete(t):await i.put(l,t),await s.done,l&&(!a||a.fid!==l.fid)&&Ju(n,l.fid),l}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class J_{constructor(e){this.Tt=e}}function Z_(n){const e=G_({parent:n.parent,structuredQuery:n.structuredQuery});return n.limitType==="LAST"?uo(e,e.limit,"L"):e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
