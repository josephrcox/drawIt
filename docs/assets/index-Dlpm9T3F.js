var Id=Object.defineProperty;var Rd=(n,e,t)=>e in n?Id(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t;var Li=(n,e,t)=>Rd(n,typeof e!="symbol"?e+"":e,t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const a of i.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&r(a)}).observe(document,{childList:!0,subtree:!0});function t(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function r(s){if(s.ep)return;s.ep=!0;const i=t(s);fetch(s.href,i)}})();function J(){}function Cd(n){return!!n&&(typeof n=="object"||typeof n=="function")&&typeof n.then=="function"}function ku(n){return n()}function hl(){return Object.create(null)}function wt(n){n.forEach(ku)}function Su(n){return typeof n=="function"}function ut(n,e){return n!=n?e==e:n!==e||n&&typeof n=="object"||typeof n=="function"}let ys;function Tt(n,e){return n===e?!0:(ys||(ys=document.createElement("a")),ys.href=e,n===ys.href)}function kd(n){return Object.keys(n).length===0}function Pu(n,...e){if(n==null){for(const r of e)r(void 0);return J}const t=n.subscribe(...e);return t.unsubscribe?()=>t.unsubscribe():t}function Wr(n){let e;return Pu(n,t=>e=t)(),e}function Qe(n,e,t){n.$$.on_destroy.push(Pu(e,t))}function dt(n,e,t){return n.set(t),e}function k(n,e){n.appendChild(e)}function q(n,e,t){n.insertBefore(e,t||null)}function j(n){n.parentNode&&n.parentNode.removeChild(n)}function yt(n,e){for(let t=0;t<n.length;t+=1)n[t]&&n[t].d(e)}function N(n){return document.createElement(n)}function Yt(n){return document.createElementNS("http://www.w3.org/2000/svg",n)}function re(n){return document.createTextNode(n)}function $(){return re(" ")}function It(){return re("")}function de(n,e,t,r){return n.addEventListener(e,t,r),()=>n.removeEventListener(e,t,r)}function E(n,e,t){t==null?n.removeAttribute(e):n.getAttribute(e)!==t&&n.setAttribute(e,t)}function Sd(n){return Array.from(n.childNodes)}function ye(n,e){e=""+e,n.data!==e&&(n.data=e)}function sn(n,e){n.value=e??""}function Yi(n,e,t,r){t==null?n.style.removeProperty(e):n.style.setProperty(e,t,"")}function Jt(n,e,t){n.classList.toggle(e,!!t)}let Or;function jt(n){Or=n}function Vu(){if(!Or)throw new Error("Function called outside component initialization");return Or}function Hr(n){Vu().$$.on_mount.push(n)}const jn=[],xr=[];let Gn=[];const fl=[],Pd=Promise.resolve();let Ji=!1;function Vd(){Ji||(Ji=!0,Pd.then(Io))}function Zi(n){Gn.push(n)}const Fi=new Set;let Un=0;function Io(){if(Un!==0)return;const n=Or;do{try{for(;Un<jn.length;){const e=jn[Un];Un++,jt(e),Dd(e.$$)}}catch(e){throw jn.length=0,Un=0,e}for(jt(null),jn.length=0,Un=0;xr.length;)xr.pop()();for(let e=0;e<Gn.length;e+=1){const t=Gn[e];Fi.has(t)||(Fi.add(t),t())}Gn.length=0}while(jn.length);for(;fl.length;)fl.pop()();Ji=!1,Fi.clear(),jt(n)}function Dd(n){if(n.fragment!==null){n.update(),wt(n.before_update);const e=n.dirty;n.dirty=[-1],n.fragment&&n.fragment.p(n.ctx,e),n.after_update.forEach(Zi)}}function Nd(n){const e=[],t=[];Gn.forEach(r=>n.indexOf(r)===-1?e.push(r):t.push(r)),t.forEach(r=>r()),Gn=e}const Is=new Set;let bn;function Fe(){bn={r:0,c:[],p:bn}}function Ue(){bn.r||wt(bn.c),bn=bn.p}function Q(n,e){n&&n.i&&(Is.delete(n),n.i(e))}function ee(n,e,t,r){if(n&&n.o){if(Is.has(n))return;Is.add(n),bn.c.push(()=>{Is.delete(n),r&&(t&&n.d(1),r())}),n.o(e)}else r&&r()}function dl(n,e){const t=e.token={};function r(s,i,a,l){if(e.token!==t)return;e.resolved=l;let c=e.ctx;a!==void 0&&(c=c.slice(),c[a]=l);const u=s&&(e.current=s)(c);let f=!1;e.block&&(e.blocks?e.blocks.forEach((m,p)=>{p!==i&&m&&(Fe(),ee(m,1,1,()=>{e.blocks[p]===m&&(e.blocks[p]=null)}),Ue())}):e.block.d(1),u.c(),Q(u,1),u.m(e.mount(),e.anchor),f=!0),e.block=u,e.blocks&&(e.blocks[i]=u),f&&Io()}if(Cd(n)){const s=Vu();if(n.then(i=>{jt(s),r(e.then,1,e.value,i),jt(null)},i=>{if(jt(s),r(e.catch,2,e.error,i),jt(null),!e.hasCatch)throw i}),e.current!==e.pending)return r(e.pending,0),!0}else{if(e.current!==e.then)return r(e.then,1,e.value,n),!0;e.resolved=n}}function Md(n,e,t){const r=e.slice(),{resolved:s}=n;n.current===n.then&&(r[n.value]=s),n.current===n.catch&&(r[n.error]=s),n.block.p(r,t)}function Re(n){return(n==null?void 0:n.length)!==void 0?n:Array.from(n)}function We(n){n&&n.c()}function Be(n,e,t){const{fragment:r,after_update:s}=n.$$;r&&r.m(e,t),Zi(()=>{const i=n.$$.on_mount.map(ku).filter(Su);n.$$.on_destroy?n.$$.on_destroy.push(...i):wt(i),n.$$.on_mount=[]}),s.forEach(Zi)}function je(n,e){const t=n.$$;t.fragment!==null&&(Nd(t.after_update),wt(t.on_destroy),t.fragment&&t.fragment.d(e),t.on_destroy=t.fragment=null,t.ctx=[])}function Od(n,e){n.$$.dirty[0]===-1&&(jn.push(n),Vd(),n.$$.dirty.fill(0)),n.$$.dirty[e/31|0]|=1<<e%31}function vt(n,e,t,r,s,i,a=null,l=[-1]){const c=Or;jt(n);const u=n.$$={fragment:null,ctx:[],props:i,update:J,not_equal:s,bound:hl(),on_mount:[],on_destroy:[],on_disconnect:[],before_update:[],after_update:[],context:new Map(e.context||(c?c.$$.context:[])),callbacks:hl(),dirty:l,skip_bound:!1,root:e.target||c.$$.root};a&&a(u.root);let f=!1;if(u.ctx=t?t(n,e.props||{},(m,p,...y)=>{const T=y.length?y[0]:p;return u.ctx&&s(u.ctx[m],u.ctx[m]=T)&&(!u.skip_bound&&u.bound[m]&&u.bound[m](T),f&&Od(n,m)),p}):[],u.update(),f=!0,wt(u.before_update),u.fragment=r?r(u.ctx):!1,e.target){if(e.hydrate){const m=Sd(e.target);u.fragment&&u.fragment.l(m),m.forEach(j)}else u.fragment&&u.fragment.c();e.intro&&Q(n.$$.fragment),Be(n,e.target,e.anchor),Io()}jt(c)}class At{constructor(){Li(this,"$$");Li(this,"$$set")}$destroy(){je(this,1),this.$destroy=J}$on(e,t){if(!Su(t))return J;const r=this.$$.callbacks[e]||(this.$$.callbacks[e]=[]);return r.push(t),()=>{const s=r.indexOf(t);s!==-1&&r.splice(s,1)}}$set(e){this.$$set&&!kd(e)&&(this.$$.skip_bound=!0,this.$$set(e),this.$$.skip_bound=!1)}}const xd="4";typeof window<"u"&&(window.__svelte||(window.__svelte={v:new Set})).v.add(xd);const Bn=[];function tr(n,e=J){let t;const r=new Set;function s(l){if(ut(n,l)&&(n=l,t)){const c=!Bn.length;for(const u of r)u[1](),Bn.push(u,n);if(c){for(let u=0;u<Bn.length;u+=2)Bn[u][0](Bn[u+1]);Bn.length=0}}}function i(l){s(l(n))}function a(l,c=J){const u=[l,c];return r.add(u),r.size===1&&(t=e(s,i)||J),l(n),()=>{r.delete(u),r.size===0&&t&&(t(),t=null)}}return{set:s,update:i,subscribe:a}}const Xe=tr(null),Gr=tr([]),mt=tr(null),gt=tr({}),Rs=tr(!1),Cs=tr(!1);try{const n=localStorage.getItem("drawIt-user-v2");n&&Xe.set(JSON.parse(n));const e=localStorage.getItem("drawIt-games-v2");e&&Gr.set(JSON.parse(e));const t=localStorage.getItem("drawIt-users-v2");t&&gt.set(JSON.parse(t))}catch(n){console.error("Error loading from localStorage:",n)}Xe.subscribe(n=>{n?localStorage.setItem("drawIt-user-v2",JSON.stringify(n)):localStorage.removeItem("drawIt-user-v2")});Gr.subscribe(n=>{n?localStorage.setItem("drawIt-games-v2",JSON.stringify(n)):localStorage.removeItem("drawIt-games-v2")});gt.subscribe(n=>{Object.keys(n).length>0?localStorage.setItem("drawIt-users-v2",JSON.stringify(n)):localStorage.removeItem("drawIt-users-v2")});const Ld=()=>{};var ml={};/**
 * @license
